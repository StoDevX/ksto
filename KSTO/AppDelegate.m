...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Sleep the app to show the start image
    [NSThread sleepForTimeInterval:2]; //add 2 seconds longer.
    
    // This allows us to customize the color of the status bar
    ...
    // This allows us to control the audio from the lockscreen or control center
